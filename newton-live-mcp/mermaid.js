...
async function renderDiagrams() {
  ...
  mermaid.initialize({ startOnLoad: false, securityLevel: "strict", theme: "base", themeVariables: colors, flowchart: { htmlLabels: false, curve: "linear", nodeSpacing: 18, rankSpacing: 24 } });
